...
def save_backup_list(backup_list, filename="log/backup_list_enroll_mahasiswa-v1.pkl"):
    with open(filename, "wb") as file:
        pickle.dump(backup_list, file)


def load_backup_list(filename="log/backup_list_enroll_mahasiswa-v1.pkl"):
    try:
    ...
    for student in students:
        ...
        if len(dataUserSikola) == 0:
            paramsAPICreateUserSikolaByField = {
                ...
                "users[0][password]": student["nim"].lower(),
...
#             "wsfunction": "core_user_get_users_by_field",
#             "field": "username",
#             "values[0]": student['nim'].lower().replace("'",''),
#         }
...
#             # print(dataUserSikolaDosen[0]["id"])
