...
async def fetch_sikola_course():
    async with aiohttp.ClientSession() as session:
        ...
        backup_file = "jumlahDosenAktif-21Jun-TA232.pkl"
            ...
            for course in result_course["courses"]:
                if active_semester in course["shortname"]:
                    if '.' in course['idnumber']:
                        ...
                        detail_kelas_path = f"data/detailKelas/TA232.12/{id_kelas}.json"
        ...
        with pd.ExcelWriter("2023-2024 Genap jumlah_dosen_aktif_perProdi_TA232.xlsx") as writer:
